...
export class ParserSourceController {
  ...
  @ApiOkResponse({ type: [ParserSourceDto], description: '查询成功' })
  ...
  @ApiCreatedResponse({ type: ParserSourceDto, description: '创建成功' })
  ...
  @ApiOkResponse({ type: ParserSourceDto, description: '更新成功' })
